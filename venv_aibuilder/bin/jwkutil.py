...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", dest="msg_file", help="File containing a message")
    ...
    parser.add_argument("-A", dest="encalg", help="The encryption alg algorithm")
    parser.add_argument("-E", dest="encenc", help="The encryption enc algorithm")
    ...
    keys = []
    if args.rsa_file:
        keys.append(RSAKey(key=import_rsa_key_from_file(args.rsa_file), kid=_kid))
    if args.hmac_key:
