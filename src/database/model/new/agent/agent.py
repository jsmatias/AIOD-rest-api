...
from database.model.new.agent.email import Email
from database.model.new.agent.telephone import Telephone
from database.model.new.ai_resource.resource import AIResource, AIResourceBase
