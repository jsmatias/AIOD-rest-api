...
from database.model.new.ai_asset.ai_asset import AIAsset
from database.model.new.field_length import NORMAL
from database.model.new.knowledge_asset.PublicationType import PublicationType
from database.model.new.knowledge_asset.knowledge_asset import KnowledgeAssetBase, KnowledgeAsset
